        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-2xl">
            <form action="{{ route('register') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    {{-- el @error sirve para poder colorear el filo de rojo, en este caso.
                    Además, 'old' sirve para que cuando envíes el formulario y este mal
                    salga el nombre que has puesto antes.(Las {{}} sirven para meter código PHP.) 
                    Sirve igual que poner: ...php ?> --}}
