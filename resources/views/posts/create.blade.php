...
{{-- el @push funciona junto al @stack, donde pongas el push, cargará la hoja de estilos de dropzone, y solamente la va cargar donde esté el push --}}
@push('styles')
        ...
        <div class="md:w-1/2 p-10 bg-white  rounded-lg shadow-2xl mt-10 md:mt-0">
            <form action="{{ route('posts.store') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="titulo" name="titulo" placeholder="Tu título"
                ...
                <div class="mb-5">
                    ...
                    <textarea type="text" id="descripcion" name="descripcion" placeholder="Tu descripción"
